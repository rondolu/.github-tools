---
name: 'Prompt-refiinging'
description: "優化你的提示詞，確保其清晰、完整且無歧義。"
...
handoffs: 
   - label: Handoff to implementation plan generation
     ...
     prompt: The prompt has been refined and is ready for implementation. Handoff to the implementation plan agent to create a detailed implementation plan based on the refined prompt.
     send: true
---
