...
const COLORS = {
  background:    "0B1826",  // Deep Navy — slide background (primary_tones)
  sidePanel:     "0E2040",  // Section Navy — left panel / card fills
  accent:        "186AFF",  // Brand Electric Blue — numbers, icons, accent lines
  white:         "FFFFFF",  // Primary text on dark backgrounds
  iceBlue:       "B2D9FC",  // Secondary text / subtitles (neutral_tones)
  mistBlue:      "82DFE8",  // Taglines / auxiliary subtitles
  midGray:       "8AABCC",  // Annotation / low-priority text
  cyanSuccess:   "36CBDA",  // Success state (accent_tones)
  warningOrange: "F75801",  // Error / warning state
  goldAlert:     "FFD600",  // Third rule label / special alert
};
```
...
// Every slide gets a Deep Navy background
slide.background = { color: COLORS.background };
```

### Recurring Decorators (add to every slide)

Map from `layout_rules.recurring_elements`. Use a helper to avoid repetition:

```javascript
// Call addRecurringDecorators(slide, chapterNum) on every slide you create.
function addRecurringDecorators(slide, chapterNum) {
  ...
  // 4. Page / section number label — 40pt Bold Electric Blue, top-left
  if (chapterNum != null) {
